...
public class ServerTest {
    ...
    public void setUp() throws Exception {
        ...
        sock = new Socket("localhost", 8080); // connect to host and socket
    ...
    @Test
    public void charCountWithoutSpecificCharacter() throws IOException {
        JSONObject req = new JSONObject();
        ...
        assertTrue(res.getBoolean("ok"));
        assertEquals("Count of characters: 13", res.getString("result"));
    }

    @Test
    public void charCountWithSpecificCharacter() throws IOException {
        JSONObject req = new JSONObject();
        req.put("type", "charcount");
        ...
        assertTrue(res.getBoolean("ok"));
        assertEquals("Count of 'o' characters: 2", res.getString("result"));
    }

    @Test
    public void storyboardAdd() throws IOException {
        JSONObject req = new JSONObject();
        ...
        assertTrue(res.getBoolean("ok"));
        assertEquals("Your sentence has been added!", res.getString("result"));
    }
